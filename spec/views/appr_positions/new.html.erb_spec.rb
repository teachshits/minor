...
describe "appr_positions/new" do
  before(:each) do
    assign(:appr_position, stub_model(ApprPosition,
      :position_id => 1,
      :Mon => 1,
      :Tue => 1,
      :Wed => 1,
  ...
  it "renders new appr_position form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => appr_positions_path, :method => "post" do
