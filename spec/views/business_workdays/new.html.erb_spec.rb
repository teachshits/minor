...
describe "business_workdays/new" do
  before(:each) do
    assign(:business_workday, stub_model(BusinessWorkday,
      :business_id => 1,
      :period_id => 1,
      :Mon => 1,
      :Tue => 1,
  ...
  it "renders new business_workday form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => business_workdays_path, :method => "post" do
